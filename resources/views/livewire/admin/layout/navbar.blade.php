    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="{{ route('admin.dashboard') }}" class="flex ml-2 md:mr-24" wire:navigate>
                    <img src="{{ Vite::asset('resources/images/sitorik_light.png') }}" alt="Sitorik Logo" class="hidden dark:block h-9">
                    <img src="{{ Vite::asset('resources/images/sitorik.png') }}" alt="Sitorik Logo" class="block dark:hidden h-9">
                </a>
