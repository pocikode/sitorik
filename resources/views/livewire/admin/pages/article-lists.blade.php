<div class="w-full">
    <div class="px-4">
        ...
        <div class="sm:flex mb-5">
            ...
            <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                <a wire:navigate href="{{ route('admin.articles.create') }}" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
            ...
            <div class="inline-block min-w-full align-middle">
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            @foreach($articles as $article)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        ...
                                        <button type="button" data-modal-target="delete-modal" data-modal-toggle="delete-modal" data-slug="{{ $article->slug }}" data-name="{{ $article->model_with_brand }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
                                            <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                                      d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z"
                        ...
                        @else
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                <td class="text-sm font-normal text-gray-500 dark:text-gray-400 text-center py-4"
                                    colspan="4">No Data Found
                                </td>
                            </tr>
                        @endif
                        </tbody>
    ...
    <div class="w-full mt-5">{{ $articles->links('components.admin.pagination') }}</div>
</div>
