<div class="w-full">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        <img class="w-10 h-10 rounded-full"
                                             src="{{ $motorcycle->picture->image ? Storage::url($motorcycle->picture->image) : '' }}"
                                             alt="{{ $motorcycle->brand->name }} {{ $motorcycle->model }}">
                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                            <div
                                                class="text-base font-semibold text-gray-900 dark:text-white">{{ $motorcycle->brand->name }} {{ $motorcycle->model }}</div>
                                        </div>
                                    </td>
    ...
    <div class="w-full mt-5">{{ $motorcycles->links('components.admin.pagination') }}</div>
</div>
