<div id="delete-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form id="deleteForm" class="p-4 md:p-5 space-y-4" action="" method="post">
                @csrf @method('delete')
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="text-xl text-center font-semibold mt-3 dark:text-white">Apakah anda yakin akan menghapus data <span id="modelToDelete"></span>?</h3>
                </div>
